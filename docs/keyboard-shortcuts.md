# LIST OF KNOWS WINDOWS 11 KEYBOARD SHORTCUTS

# RULES OF USE

- Agent must match the shell keyboard hotkeys as closely with Windows 11 as possible.
...
Win + Ctrl + Shift + B 	Restart Desktop Window Manager. 		11 	It's not the GPU driver! source
...
Win + A 	Open Quick Settings. 		11 	
Win + C 	Open Windows Copilot. 	Windows Copilot present. 	11 	
Win + E 	Open File Explorer. 		11 	
Win + F 	Open Feedback Hub. 		11 	A screenshot will be taken and added to a new feedback post. It cannot be used elsewhere.
Win + G 	Open Xbox Game Bar. 		11 	
Win + K 	Open Cast from Quick Settings. 		11 	
Win + N 	Open notification center and calendar. 		11 	
Win + Ctrl + O 	Open/Close on-screen keyboard. 		11 	
Win + Ctrl + Q 	Open Quick Assist. 		11 	
Win + R 	Open the Run dialog box. 		11 	
Win + S 	Open search. 		11 	
Win + Shift + S 	Open snipping tool. 		11 	
Win + W 	Open Widgets. 		11 	
Win + X 	Open the Quick Link menu. 		11 	
